...
public class DeviceSpinnerAdapter extends ArrayAdapter {
    List<RespDeviceModelInfo> mData;
    Context mContext;
    LayoutInflater inflater;

    public DeviceSpinnerAdapter(Context context, List<RespDeviceModelInfo> model){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String text = mData.get(position).getModelName();
